...
def test_prefix_name_matching_with_team_disambiguation():
    ...
    fg_robert_nyy = FangraphsBatterModel(
        playerid="1", name="Robert Smithson", ascii_name="Robert Smithson", team="NYY"
    )

    fg_robert_bos = FangraphsBatterModel(
        playerid="2", name="Robert Smithson", ascii_name="Robert Smithson", team="BOS"
    )
...
def test_prefix_name_matching_ambiguous():
    ...
    fg_michael1 = FangraphsBatterModel(
        playerid="1", name="Michael Smith", ascii_name="Michael Smith", team="NYY"
    )

    fg_michael2 = FangraphsBatterModel(
        playerid="2", name="Michael Smith", ascii_name="Michael Smith", team="BOS"
    )
...
def test_team_only_matching_ambiguous():
    ...
    fg_player1 = FangraphsBatterModel(
        playerid="1", name="John Playerson", ascii_name="John Playerson", team="NYY"
    )

    fg_player2 = FangraphsBatterModel(
        playerid="2", name="Mike Playerson", ascii_name="Mike Playerson", team="NYY"
    )
...
def test_no_match_no_candidates():
    ...
    player = EspnBatterModel(
        id=1, name="John Smith", first_name="John", last_name="Smith", pro_team="LAD"
    )

    # FanGraphs player with same last name but different team
    fg_player = FangraphsBatterModel(
        playerid="1", name="Mike Smith", ascii_name="Mike Smith", team="NYY"
    )
...
def test_exact_name_with_team_disambiguation():
    ...
    player = EspnBatterModel(
        id=1, name="Mike Trout", first_name="Mike", last_name="Trout", pro_team="LAA"
    )

    # Two Mike Trouts on different teams (edge case)
    fg_trout_laa = FangraphsBatterModel(
        playerid="10155", name="Mike Trout", ascii_name="Mike Trout", team="LAA"
    )

    fg_trout_nyy = FangraphsBatterModel(
        playerid="99999", name="Mike Trout", ascii_name="Mike Trout", team="NYY"
    )
...
def test_empty_name_handling():
    ...
    player = EspnBatterModel(
        id=1, name="Smith", first_name="", last_name="Smith", pro_team="NYY"
    )

    fg_player = FangraphsBatterModel(
        playerid="1", name="Smith", ascii_name="Smith", team="NYY"
    )
...
def test_filter_by_team_with_espn_mapping():
    ...
    # FanGraphs uses KCR
    fg_player = FangraphsBatterModel(
        playerid="123", name="Player One", ascii_name="Player One", team="KCR"
    )
...
def test_no_last_name_no_candidates():
    ...
    player = EspnBatterModel(
        id=1, name="SingleName", first_name="SingleName", last_name="", pro_team="NYY"
    )

    fg_player = FangraphsBatterModel(
        playerid="123", name="John Smith", ascii_name="John Smith", team="NYY"
    )
...
def test_prefix_match_reverse_direction():
    ...
    fg_player = FangraphsBatterModel(
        playerid="123", name="Chris Smith", ascii_name="Chris Smith", team="NYY"
    )
